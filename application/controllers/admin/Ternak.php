...
class Ternak extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['ternak'] = $this->Ternak_model->getTernak();

        $data = [
            "title" => 'Daftar Peternakan',
            "ternak"  => $data['ternak'],
            "isi"   => 'admin/ternak/list'
        ];
    ...
    public function tambah()
    {
        ...
        if( $valid->run() ) {
            ...
            if( ! $this->upload->do_upload('gambar') ) {
                ...
                redirect(base_url('admin/ternak'));
            }}
    ...
    public function delete($id_ternak)
    {
        ...
        redirect(base_url('admin/ternak'), 'refresh');
    }
    ...
    public function delete_gambar($id_ternak, $id_gambar)
    {
        ...
        redirect(base_url('admin/Produk/gambar/'.$id_ternak), 'refresh');
    }
